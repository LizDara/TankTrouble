...
{
    class SecondExplosion : Parte
    {
        float[] vertexExplosion = {
            -0.55f, 0.5f,  0.5f,    0.63f, 0.42f,
             0.55f, 0.5f,  0.5f,    0.765f, 0.42f,
             0.55f, 0.5f, -0.5f,    0.765f, 0.61f,
            -0.55f, 0.5f, -0.5f,    0.63f, 0.61f
        };
        uint[] index = {
            0, 1, 2,
            2, 3, 0
        };
        public SecondExplosion()
        {
            key = "secondExplosion";
            draw = false;
