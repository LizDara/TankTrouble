...
{
    class SixthExplosion : Parte
    {
        float[] vertexExplosion = {
            -0.82f, 0.5f,  0.73f,    0.4f, 0.07f,
             0.82f, 0.5f,  0.73f,    0.6f, 0.07f,
             0.82f, 0.5f, -0.73f,    0.6f, 0.35f,
            -0.82f, 0.5f, -0.73f,    0.4f, 0.35f
        };
        uint[] index = {
            0, 1, 2,
            2, 3, 0
        };
        public SixthExplosion()
        {
            key = "sixthExplosion";
            draw = false;
