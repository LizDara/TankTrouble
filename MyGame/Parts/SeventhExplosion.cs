...
{
    class SeventhExplosion : Parte
    {
        float[] vertexExplosion = {
            -0.61f, 0.5f,  0.73f,    0.63f, 0.07f,
             0.61f, 0.5f,  0.73f,    0.78f, 0.07f,
             0.61f, 0.5f, -0.73f,    0.78f, 0.35f,
            -0.61f, 0.5f, -0.73f,    0.63f, 0.35f
        };
        uint[] index = {
            0, 1, 2,
            2, 3, 0
        };
        public SeventhExplosion()
        {
            key = "seventhExplosion";
            draw = false;
